  ...
  fetchTemplateFor(pageSlug) {
    if(pageSlug === '404') {
      ...
      if(this.DEV_TEMPLATE_FOLDER) {
        fetch = function() { return RSVP.resolve(fs.readFileSync('404.hbs', 'utf8')); }.bind(this);
      } else {
        fetch = function() { return this._compiler.fetchFromS3('404.hbs').then(res => res.Body); }.bind(this);
      }
